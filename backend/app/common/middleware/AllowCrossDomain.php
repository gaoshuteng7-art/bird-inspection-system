...
class AllowCrossDomain
{
    protected $header = [
        ...
        'Access-Control-Allow-Headers'     => 'think-lang, server, user-token, ba-user-token, batoken, Authorization, Content-Type, If-Match, If-Modified-Since, If-None-Match, If-Unmodified-Since, X-CSRF-TOKEN, X-Requested-With',
    ];
